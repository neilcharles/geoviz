...
#' @param pct_alt_low The percent of maximum altitude contained in altitude_raster at which alpha_max will apply
#' @param pct_alt_high The percent of maximum altitude contained in altitude_raster at which alpha_min will apply
#'
